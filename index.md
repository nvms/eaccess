...
1. Call `createAuthTables(config)` once to set up the database tables
1. Every request gets `req.auth` with methods for login, register, roles, MFA, OAuth
1. Optionally mount the admin UI for user management
